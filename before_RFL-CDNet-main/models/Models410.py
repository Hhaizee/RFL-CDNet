...
class SNUNet_ECAM(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=2, sync_bn=False):
        ...
        self.conv_final1 = nn.Conv2d(filters[0], out_ch, kernel_size=1)
        self.conv_final2 = nn.Conv2d(filters[0], out_ch, kernel_size=1)
        self.conv_final3 = nn.Conv2d(filters[0], out_ch, kernel_size=1)
        self.conv_final4 = nn.Conv2d(filters[0], out_ch, kernel_size=1)
