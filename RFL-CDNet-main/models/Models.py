...
class SNUNet_ECAM_XWJ(nn.Module):
    # SNUNet-CD with ECAM
    def __init__(self, in_ch=3, out_ch=2, sync_bn=False):
        super(SNUNet_ECAM_XWJ, self).__init__()
...
class SNUNet_ECAM(nn.Module):
    ...
    def __init__(self, in_ch=3, out_ch=2, sync_bn=False):
        ...
        self.Up1 = up(filters[1], scale_factor=2)
        self.Up2 = up(filters[2], scale_factor=4)
        self.Up3 = up(filters[3], scale_factor=8)
        self.Up4 = up(filters[4], scale_factor=16)
    ...
    def forward(self, xA, xB):
        ...
        out = torch.cat([x0_1, x0_2, x0_3, x0_4], 1)
        # the first scale
        # =====> FLOPs: 99.368042496 G, Params: 22.930992 M
        
        x1_1 = self.Up1_1(x1_1)
        x1_2 = self.Up1_2(x1_2)
        x1_3 = self.Up1_3(x1_3)
        
        print("==> annotate ca/sa 1")
        # x1_1 = self.ca1_1(x1_1) * x1_1
        # x1_1 = self.sa1_1(x1_1) * x1_1
        # x1_2 = self.ca1_2(x1_2) * x1_2
        # x1_2 = self.sa1_2(x1_2) * x1_2
        ...
        print("%%% delete Up3_1")
        # print("== x3_1.shape: {}".format(x3_1.shape))  (1, 384, 32, 32)
        # x3_1 = self.Up3_1(x3_1)
        # x3_1 = torch.ones((1, 384, 64, 64)).to("cuda")
        # print("== x3_1.shape: {}".format(x3_1.shape)) (1, 384, 64, 64)
        # x3_1 = self.Up3_1_1(x3_1)
        x3_1 = self.Up3(x3_1)
        ...
        print("*** annotate out sa/ca 0")
        # out = self.ca(out) * out
        # out = self.sa(out) * out
        #out = self.conv_final(out)
        
        print("@@@ not conv_final 0")
        # score_0 = self.conv_final(out)
        score_0 = torch.ones((1, 2, 256, 256)).to("cuda")
        # print("out shape: {}".format(out.shape))
        # print("score_0 shape: {}".format(score_0.shape))
        
        print("*** annotate out sa/ca 1")
        # out1 = self.ca1(out1)*out1
        # out1 = self.sa1(out1)*out1
        #out1 = self.conv_final1(out1)
        
        print("@@@ not conv_final 1")
        # score_1 = self.conv_final1(out1)
        score_1 = torch.ones((1, 2, 256, 256)).to("cuda")
        # print("out1 shape: {}".format(out1.shape))
        # print("score_1 shape: {}".format(score_1.shape))
        
        print("*** annotate out sa/ca 2")
        # out2 = self.ca2(out2)*out2
        # out2 = self.sa2(out2)*out2
        #out2 = self.conv_final2(out2)
        
        print("@@@ not conv_final 2")
        score_2 = torch.ones((1, 2, 256, 256)).to("cuda")
        # score_2 = self.conv_final2(out2)
        # print("out2 shape: {}".format(out2.shape))
        # print("score_2 shape: {}".format(score_2.shape))
        
        print("*** annotate out sa/ca 3")
        # out3 = self.ca3(out3)*out3
        # out3 = self.sa3(out3)*out3
        
        print("@@@ not conv_final 3")
        # out3 = self.conv_final3(out3)
        out3 = torch.ones((1, 2, 256, 256)).to("cuda")
        score_3 = out3
        # print("out3 shape: {}".format(out3.shape))
        # print("score_3 shape: {}".format(score_3.shape))
        
        print("==> early return")
        return [out, out1, out2, out3, score_0, score_1, score_2, score_3]
