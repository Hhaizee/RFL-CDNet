...
#            cd_preds1 = model(batch_img1, batch_img2)
...
#            cd_loss = criterion(cd_preds1, labels)+criterion(cd_preds1, labels)+criterion(cd_preds2, labels)
#            cd_loss = criterion(cd_preds1, labels)
